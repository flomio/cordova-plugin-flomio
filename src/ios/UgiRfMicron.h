 ...
 */
+ (UgiRfidConfiguration *) configToReadMagnusSensorValue:(UgiInventoryTypes)inventoryType
...
/**
 ...
 @return             Sensor code
 */
+ (int) getMagnusSensorCode:(UgiDetailedPerReadData *)perReadData;
...
/**
 ...
 @return             On-chip RSSI
 */
+ (int) getMagnusOnChipRssi:(UgiDetailedPerReadData *)perReadData;
...
/**
 ...
 @return                    Configuration structure
 */
+ (UgiRfidConfiguration *) configToReadMagnusTemperature:(UgiInventoryTypes)inventoryType;
 ...
 */
+ (double) getMagnusTemperature:(UgiTag *)tag
                    perReadData:(UgiDetailedPerReadData *)perReadData;
