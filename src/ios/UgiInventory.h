...
@property (retain) id<UgiInventoryDelegate> delegate;
...
@property (readonly, nonatomic) NSArray<UgiTag *> *tags;
 ...
 */
typedef void (^GetBatteryInfoCompletion)(UgiBatteryInfo *info);
 ...
 */
- (void) getBatteryInfoWithCompletion:(GetBatteryInfoCompletion)completion;
